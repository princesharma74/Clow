        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <address className="space-y-2 text-sm not-italic">
              <p>Bangalore, India</p>
              <p>Email: <a href={`mailto:${contactDetails.email}`} className="hover:underline">{contactDetails.email}</a></p>
            </address>
          </div>
          ...
          <div className="relative">
            ...
            <div className="mb-6 flex space-x-4">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link href={contactDetails.social.facebook} target="_blank">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link href={contactDetails.social.twitter} target="_blank">
                    <Button variant="outline" size="icon" className="rounded-full">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link href={contactDetails.social.instagram} target="_blank">
                    <Button variant="outline" size="icon" className="rounded-full">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link href={contactDetails.social.linkedin} target="_blank">
                    <Button variant="outline" size="icon" className="rounded-full">
